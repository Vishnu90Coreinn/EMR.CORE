using EMR.CORE.Application.Common.Persistence;
using EMR.CORE.Domain.Common.Contracts;
using EMR.CORE.Infrastructure.Common;
using EMR.CORE.Infrastructure.Persistence.ConnectionString;
using EMR.CORE.Infrastructure.Persistence.Context;
using EMR.CORE.Infrastructure.Persistence.Initialization;
using EMR.CORE.Infrastructure.Persistence.Repository;
...
namespace EMR.CORE.Infrastructure.Persistence;
